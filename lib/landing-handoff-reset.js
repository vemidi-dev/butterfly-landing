...
const LANDING_ASSET_VERSION = '20260622-handoff-7';
...
function setOrderButtonHandoffSubmittingState(
  orderBtn,
  submittingText = HANDOFF_SUBMITTING_BUTTON_TEXT,
) {
  if (!orderBtn) {
    return;
  }
  orderBtn.textContent = submittingText;
